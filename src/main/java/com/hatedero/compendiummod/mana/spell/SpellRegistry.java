...
public class SpellRegistry {
    ...
    public static final DeferredHolder<Spell, Spell> MADE_IN_HEAVEN = SPELLS.register("made_in_heaven",
            () -> new MadeInHeavenSpell(1, -1, 20));

    public static final DeferredHolder<Spell, Spell> LONGINUS_SPEAR = SPELLS.register("longinus_spear",
            () -> new LonginusSpearSpell(1, 200, 20));
}